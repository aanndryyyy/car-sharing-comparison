    ...
    <label class="block mb-6">
      ...
      <div class="flex-row md:flex-col lg:flex-row flex gap-2">
        ...
        <div class="relative">
          ...
          <span class="absolute leading-none text-gray-500 text-[10px] font-bold right-4 top-2/4 -translate-y-2/4">{$_('planner.input.day', { values: { count: inputDays } })}</span>
        </div>
        ...
        <div class="relative">
          ...
          <span class="absolute leading-none text-gray-500 text-[10px] font-bold right-4 top-2/4 -translate-y-2/4">{$_('planner.input.hour', { values: { count: inputHours } })}</span>
        </div>
        ...
        <div class="relative">
          ...
          <span class="absolute leading-none text-gray-500 text-[10px] font-bold right-4 top-2/4 -translate-y-2/4">{$_('planner.input.minute', { values: { count: inputMinutes } })}</span>
        </div>
      </div>
