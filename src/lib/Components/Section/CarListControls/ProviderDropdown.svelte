<script>
  ...
  let items = [
    { title: 'Bolt', value: Provider.BOLT },
    { title: 'CityBee', value: Provider.CITYBEE },
    { title: 'Elmo', value: Provider.ELMO },
    { title: 'Beast', value: Provider.BEAST },
    { title: 'Avis', value: Provider.AVIS },
  ]
</script>
